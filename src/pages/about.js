          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-6 flex flex-col items-start justify-start xl:col-span-12">
              ...
              <p className="font-medium my-5">
                ...
                hats because there&apos;s more to this story – I&apos;m not just
                your average software wizard; I&apos;m also an intrepid traveler
                and a budding YouTuber, ready to capture and share every
                exhilarating moment of my adventures with the world.
              </p>
              <p className="font-medium my-5">
                You&apos;ll often find me right in the heart of tech
                communities, spreading the contagious joy of coding and eagerly
                soaking up knowledge at every turn. Whether it&apos;s diving
                into the intricacies of a new framework or unraveling the
                mysteries of the latest tech trends, I&apos;m always up for the
                challenge!
              </p>
              <p className="font-medium my-5">
                And speaking of challenges, I&apos;m currently on cloud nine
                immersing myself in the captivating world of LowCode, exploring
                platforms like OutSystems and Mendix. It&apos;s like embarking
                on a thrilling expedition every day, filled with new discoveries
                and adrenaline-pumping revelations. And you bet I&apos;ll be
                sharing every step of this electrifying journey with you on my
                YouTube channel!
              </p>
              <p className="font-medium my-5">
                So, got a wild project idea or itching to talk tech? Well,
                you&apos;re in luck because I&apos;m all ears! Feel free to
                reach out to me on any of my social media links. Let&apos;s ride
                this wave of excitement together and create some magic both on
                and off the screen! 🚀✨
              </p>
            </div>
