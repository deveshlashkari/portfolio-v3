...
export const MusicIcon = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    viewBox="0 0 490 490"
    ...
    className={`w-full h-auto ${className}`}
  >
    <path d="M470 133.438H288.866c-3.099-13.596-12.362-24.867-24.691-30.699l78.085-82.423-14.52-13.755L245 93.898 162.26 6.561l-14.52 13.756 78.085 82.423c-12.33 5.832-21.593 17.104-24.691 30.699H20c-11.028 0-20 8.972-20 20v320c0 5.522 4.478 10 10 10h470c5.522 0 10-4.478 10-10v-320c0-11.029-8.972-20.001-20-20.001zm-225-15c10.23 0 19.041 6.18 22.906 15h-45.813c3.866-8.82 12.677-15 22.907-15zm-225 35h345v270H20v-270zm450 310H20v-20h450v20zm0-40h-85v-270h85v270z" />
    <path d="M340 168.438H45c-5.522 0-10 4.478-10 10v220c0 5.523 4.478 10 10 10h295c5.522 0 10-4.478 10-10v-220c0-5.522-4.478-10-10-10zm-10 220H55v-200h275v200z" />
    <path d="M90 223.438h15v-20H80c-5.522 0-10 4.478-10 10v45h20v-35zM70 273.438h20v20H70zM427.5 343.438c15.163 0 27.5-12.337 27.5-27.5s-12.337-27.5-27.5-27.5-27.5 12.337-27.5 27.5 12.337 27.5 27.5 27.5zm0-35c4.206 0 7.5 3.294 7.5 7.5s-3.294 7.5-7.5 7.5-7.5-3.294-7.5-7.5 3.294-7.5 7.5-7.5zM427.5 408.438c15.163 0 27.5-12.337 27.5-27.5s-12.337-27.5-27.5-27.5-27.5 12.337-27.5 27.5 12.337 27.5 27.5 27.5zm0-35c4.206 0 7.5 3.294 7.5 7.5s-3.294 7.5-7.5 7.5-7.5-3.294-7.5-7.5 3.294-7.5 7.5-7.5zM405 253.438h45v20h-45zM405 213.438h45v20h-45zM405 173.438h45v20h-45z" />
  </svg>
);
